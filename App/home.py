...
def app():
    ...
    with tab3:
        ...
        fig.add_trace(go.Scatter(x = visuals['date'], y = visuals['temp'], name = 'Temperature', mode ='lines', line=dict(color = 'firebrick')), secondary_y = False)
        fig.add_trace(go.Bar(x = visuals['date'], y = visuals['prcp'], name = 'Precipitation', marker = dict(color = 'royalblue')), secondary_y = True)
